...
The goal of this project is to develop a **generalizable** and **resilient** model capable of making **robust predictions**, even when under the influence challenging environmental factors such as blur, occlusion, lighting changes, jitter, noise and rotation.
