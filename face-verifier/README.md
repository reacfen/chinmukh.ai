...
The face verifier is a fine-tuned **ResNet-50** model trained using an [ArcFace](https://arxiv.org/pdf/1801.07698) classifier head that takes an input image of size `(224 × 224)` and outputs an **embedding vector of a fixed size** (usually 512 by convention) representing the identity of the person in the image.
