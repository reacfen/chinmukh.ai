...
The gender classifier is a fine-tuned **EfficientNet-b1** model that takes an input image of size `(224 × 224)` and outputs a logit of either `0` (representing **female**) or `1` (representing **male**).
...
graph TD
    ...
    F --> G["Sigmoid (optional)<br/>Gender Probability"]
```
